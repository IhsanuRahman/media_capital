...
function Header({ leading }) {
    ...
    const popupComponent = (
        <div class="bg-black border gap-4 pt-5  d-flex flex-column align-items-center " onMouseLeave={_ => setPopup(null)} style={{ position: 'fixed', zIndex: '3', right: '10px', top: '55px', height: '300px', width: '400px' }}>
            <div className='bg-light  btn' style={{ height: '80px', width: '80px ', borderRadius: '100%', backgroundSize: 'cover', backgroundImage: `url(http://127.0.0.1:8000${user.profile})` }}>
            ...
            <div className="d-flex w-100 justify-content-center gap-3 ">
                ...
                >
                    ...
                    logout</button><button className='btn btn-outline-light w-25 gap-2'> <img src={ProfileIcon} alt="" />profile</button>
            </div>
        </div>
    )
    ...
    return (
        <>
            <div className='w-100 fixed-top  d-flex align-items-center' style={{ backgroundColor: '#111111', height: '50px' }}>
                ...
                <h3 className='fw-bolder  pt-3'>Media Capital</h3>
                <div className='ms-auto d-flex justify-content-between ' style={{ width: '80px' }}  >
                    ...
                    <div className=' rounded-5 btn ' type="button" style={{ height: '35px', width: '35px ', backgroundSize: 'cover', backgroundImage: `url(http://127.0.0.1:8000${user.profile})` }} onMouseEnter={_ => setPopup(popupComponent)} >
