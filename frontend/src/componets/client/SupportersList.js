...
function SupportersList({ list, type }) {
    var [arrlist, setArrList] = useState([...list])
    const dispatch=useDispatch()
    const [message,setMessage]=useState()
    const tostRef = useRef()
    return (
        <div class="modal fade" id={`${type}Backdrop`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" data-bs-theme="dark" aria-labelledby={`${type}BackdropLabel`} aria-hidden="true">
                ...
                <div class="modal-content bg-black ">
                    ...
                    <div class="modal-body">
                        <div className='d-flex flex-column'>
                            {arrlist.length > 0 ? arrlist.map((user,idx) => {
