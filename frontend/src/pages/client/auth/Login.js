...
function Login() {
    ...
    return (
        <div className=" d-flex flex-column  align-items-center justify-content-around m-0 h-100" >
            <div className='mb-5 mt-3' style={{height:'60px'}}>
            {alert && <div className="alert m alert-danger alert-dismissible fade show pe-0" role="alert">
                {alert}
            ...
            <div className='col-sm-8 col-md-7 col-10 flex-column d-flex pt-4 rounded-4 align-items-center mb-auto' style={{ backgroundColor: '#494949', height: '400px' }}>
                <div className='col-sm-8 col-md-8  col-10 flex-column d-flex   align-items-center'>
                    ...
                    <p className="text-primary text-start align-items-start mb-0 mt-2 me-auto" style={{ cursor: 'pointer' }} onClick={_ => navigator('/signup')}>create new account?</p>
                    <p className="text-primary text-start align-items-start  me-auto" style={{ cursor: 'pointer' }} onClick={_ => navigator('/forgotpassword')} >fogot password?</p>
