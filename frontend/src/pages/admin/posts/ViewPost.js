...
function ViewPost() {
    ...
    return (
        <div className='pt-5 bg-main text-dark  h-100 w-100'>
            <Header />
                ...
                <div className='  rounded-1 ' style={{ width: '600px', borderColor: '#494949', borderWidth: '2px ', borderStyle: 'solid' }}>
                    ...
                    <div className='w-100 justify-content-between d-flex flex-column ps-1' style={{}}>
                        ...
                        <div className="w-100 ps-3 row gap-2 mt-2 clearfix mt-2">
                            {post.tags.map(tag => <div className='rounded-5 ps-2  col d-flex align-items-center ps-1 border-dark border  p-1 text-center' >
                                {'#' + tag}
                            </div>)}
                        </div>
                        ...
                        <div className='d-flex flex-column'>
                            {comments.map((comment, idx) => {
                                ...
                                return <div id={idx} className="d-flex border border-dark   rounded ms-2 mb-1 me-2 p-1 align-items-center ps-2">
                            ...
                            {comment.length===0&&<p className='w-100 ps-4 text-muted'>no comments</p>}
                        </div>
                    </div>
                </div>
            </div>}
