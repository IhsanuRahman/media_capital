        ...
        <div className='bg-main text-dark overflow-y-scroll d-flex flex-column justify-content-center align-items-center' style={{ height: '100%', weight: '100%', paddingTop: '50px' }}>
            ...
            <div className='w-100 h-75  d-flex row ' >
                <div className="align-items-center d-flex flex-column ps-5  " style={{ width: '200px' }}>
                    <div className=' rounded-circle d-flex flex-column    bg-secondary  ' style={{ cursor: 'pointer', height: '150px', minWidth: '150px ', backgroundSize: 'cover', marginTop: '-50px', backgroundImage: `url(${userData.profile !== ''? URL.createObjectURL(userData.profile) : baseUrl + '/media/user_profiles/profile.png'})` }}  >
                ...
                <div className=' w-max d-flex'>
                    <div className='d-flex gap-3  flex-column w-75 p-5'>
                        ...
                        <input type="password" value={userData.password} className='form-control bg-main border-dark' placeholder='new password' style={{ height: '35px' }}
                            onChange={(e) => {
                                setUserData({ ...userData, password: e.target.value })
                            }}
                        />
                        {errors.password !== '' && <li className="text-danger ms-2">{errors.password}</li>}
                        <input type="password" value={userData.confirm_password} className='form-control bg-main border-dark' placeholder='confirm password' style={{ height: '35px' }}
                            onChange={(e) => {
